...
//	public boolean deleteCar(int vin);     //D - delete	
	...
	public void OfferDAOsetup () {
		...
		testOffer1.setOfferId(10);
		testOffer1.setCustomerName("Kathy");
		testOffer1.setStatus("PENDING");
		testOffer1.setCarVin(1789);
		testOffer1.setPrice(13579);
		twoOffers.add(testOffer1);
		
		testOffer2 = new Offer();
		testOffer2.setOfferId(11);
		testOffer2.setCustomerName("Kimberly");
		testOffer2.setStatus("PENDING");
		testOffer2.setCarVin(1789);
		testOffer2.setPrice(24680);
	...
	public void offer_readOffer () {
		OfferDAOsetup();
		Offer actual = offerDAO.readOffer(10);
	...
	public void CustomerDAOsetup () {
		...
		testCustomer1.setEmployeeFlag(1);
		...
		testCustomer2.setCustomerName("Zxgyunda");
	...
	public void customer_deleteCustomer() {
		...
		assertFalse(customerDAO.deleteCustomer("Zxgyunda"));
